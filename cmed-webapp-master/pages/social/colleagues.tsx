...
import Chat from '../../components/Colleagues/Chat';
import Conversations from '../../components/Colleagues/Conversations';
import Footer from '../../components/Footer/Footer';
import { QuickActionsMenu } from '../../components/QuickActionsMenu';
import SocialNavbar from '../../components/SocialNavbar';
import useCustomTheme from '../../utilities/hooks/useTheme';

const Colleagues: NextPage = () => {
  useAutoRedirect();
      ...
      <Stack width={'100%'} direction={'row'} justifyContent={'center'}>
        ...
        >
          ...
          <Stack sx={{ width: '100%', height: '100%' }} gap={'20px'}>
            <Chat name={'Paul Muller'} avatar={'/images/avatar.png'} online />
          </Stack>
        </Stack>
      </Stack>
